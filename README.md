...
2. `targetProjectId`: 在B站点b项目（需已存在，如没有，则需先创建），获取项目id，页面链接最后部分，如`http://mock.myscrm.cn/project/5a237f84b151d83fc77629f1`，项目id为`5a237f84b151d83fc77629f1`
3. `requestHeaders`: 在B站点上获取一个ajax接口headers
4. 将上述三个参数粘贴至`index.js`文件对应变量中
5. 运行：`yarn start`, 或`npm start`
